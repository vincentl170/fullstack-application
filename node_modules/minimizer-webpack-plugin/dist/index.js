...
class MinimizerPlugin {
  ...
  constructor(options) {
    ...
    const minimizers = typeof declaredMinify !== "undefined" ? declaredMinify : (/** @type {MinimizerImplementation<T>} */
  ...
  async optimize(compiler, compilation, assets, optimizeOptions) {
    ...
    const flagsByMinimizer = implementations.map(one => declaredFlags(one, "minimized"));
  ...
  assetFlags() {
    const flags = new Set();
    for (const flag of declaredFlags(this.options.minimizer.implementation, "minimized")) {
      flags.add(flag);
    }
  ...
  apply(compiler) {
    ...
    compiler.hooks.compilation.tap(pluginName, compilation => {
      ...
      if (this.minimizers().length > 0 && embeddedHooks.renderEmbeddedSource && embeddedHooks.embeddedSourceHash) {
